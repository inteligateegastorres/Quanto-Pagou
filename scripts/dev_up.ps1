...
foreach ($sqlFile in @("sql/001_analytics.sql", "sql/002_resilience.sql", "sql/003_tce_pr.sql", "sql/004_escolas.sql", "sql/005_manchetes.sql", "sql/006_perf_indexes.sql", "sql/007_eliminacao.sql")) {
